...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //设置作者名字
        globalConfig.setAuthor("<a href=\"https://github.com/Dazhou-del\">Dazhou</a>");
        ...
        packageConfig.setParent("com.dazhou.chatroom.common.user");//自定义包的路径
